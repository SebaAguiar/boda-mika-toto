...
const PartyDataCard: React.FC<IPartyDataCardProps> = ({
	...
	return (
		<>
			<div className="w-[60%] lg:w-1/4 h-[400px] lg:h-[450px] rounded-lg text-[#83968d] bg-[#efede7] flex flex-col items-center justify-center text-center gap-6 m-4 p-3">
				<h3 className="text-4xl md:text-4xl montserratFont">{title}</h3>
