...
const PartyDataCard: React.FC<IPartyDataCardProps> = ({
	...
	return (
		<>
			<div className="w-[60%] md:w-2/4 lg:w1/4 h-[400px] md:h-[500px] rounded-lg text-[#83968d] bg-[#efede7] flex flex-col items-center justify-center text-center gap-6 m-4 p-3">
